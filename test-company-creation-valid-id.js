...
// Generate a valid admin token with a valid ObjectId format
const JWT_SECRET = 'proplex_jwt_secret';
const adminPayload = {
  id: '507f1f77bcf86cd799439011', // This is a valid ObjectId format (24 hex characters)
...
const companyData = {
  "name": "proplex Rwa Valid ID " + Date.now(),  // Make it unique with timestamp
  "industry": "Blockchain",
